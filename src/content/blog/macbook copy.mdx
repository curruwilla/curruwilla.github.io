...
<ProductCard sku="fone_bluethooth_x1" />

<ProductCard sku="fone_bluethooth_x1" badge="destaque" />

<ProductCard sku="fone_bluethooth_x1" badge="recomendado" compact="{true}" />

**If you know HTML, you already know enough to write your first Astro component.**

<ProductCardCompact sku="fone_bluethooth_x1" badge="recomendado" />

<ProductCardCompact sku="fone_bluethooth_x1" variant="minimal" />

<ProductCardCompact sku="fone_bluethooth_x1" variant="inline" badge="melhor-custo" />
